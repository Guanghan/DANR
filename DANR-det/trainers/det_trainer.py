...
from models.decoder import centernet_decode
from models.tensor_utils import _sigmoid
from utils.debugger import Debugger
from utils.post_process import centernet_post_process
from utils.oracle_utils import gen_oracle_map
from .base_trainer import BaseTrainer


class CtSSLoss(torch.nn.Module):
    ...
    def forward(self, outputs, outputs_flipped):
        opt = self.opt
        hm_loss, em_loss = 0, 0
