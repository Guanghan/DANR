...
BN_MOMENTUM = 0.1
__all__ = ['SplAtConv2d', 'ResNet', 'Bottleneck', 'resnest50']
_url_format = 'https://s3.amazonaws.com/encoding/models/{}-{}.pth'
...
def resnest50(pretrained=False, root='/home/DANR/weights', **kwargs):
