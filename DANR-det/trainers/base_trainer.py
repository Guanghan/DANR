...
from models.tensor_utils import image_mixup


class ModelWithLoss(torch.nn.Module):
    def __init__(self, model, loss, ss_loss=None):
...
class BaseTrainer(object):
    ...
    def set_device_distributed(self, gpus, device):
    ...
    def val_for_eval(self, epoch, data_loader):
