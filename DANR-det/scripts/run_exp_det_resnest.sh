...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 /home/DANR/train_distributed_indoor.py \
 --exp_id indoor  --dataset indoor --num_classes 7 --batch_size 16 --gpus 0,1,2,3 \
 --image_mixup --lr_step 90,110 --num_epochs 120 --save_all \
 --arch resnest_50  # backbone: ResNeSt50
...
--exp_id indoor_render512native_split55  --dataset indoor --num_classes 7 --batch_size 16 --gpus 0,1,2,3 \
