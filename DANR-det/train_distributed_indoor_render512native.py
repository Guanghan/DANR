...
from dataset.det.indoor_render512native_centernet import CenterIndoorRender512NativeDataset
...
if __name__ == '__main__':
    ...
    train_dataset_indoor_render, val_dataset_indoor_render = get_dataset(opt, dataset_name="indoor_render512native")
